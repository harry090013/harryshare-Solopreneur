    ...
    timelineSteps = [
      {
        ...
        iconName: 'Leaf',
        description: 'Harry chọn đi chậm lại sau giai đoạn đi làm thuê. Harry muốn tập trung phát triển nghề sản xuất nhang sạch thảo mộc của gia đình và mở một quán chay nhỏ yên bình. Harry nhận ra niềm vui của mình lúc này là được tự làm ra những sản phẩm lành tính, gieo những duyên tốt lành cho mọi người xung quanh.',
        lesson: 'Bài học: Sự kiên nhẫn tích lũy giá trị thực giúp Harry bình tĩnh hơn, không còn nôn nóng chạy theo những con số ngắn hạn.',
      ...
      },
      {
        ...
        iconName: 'Cloud',
        description: 'Harry gia nhập CloudFly để nghiên cứu sâu về hạ tầng mạng, SEO website và ứng dụng AI tự động hóa vào marketing. Harry tự tay xây dựng các quy trình tự động hóa quy trình làm việc cùng các trợ lý AI để giải phóng sức lao động của chính mình. Tối đến, Harry tự học thêm tiếng Anh để mở rộng thế giới quan.',
        lesson: 'Bài học: Harry nhận ra AI không thay thế con người, nhưng biết cách tận dụng AI giúp Harry giải quyết lượng công việc khổng lồ một mình.',
      ...
      },
      {
        ...
        iconName: 'Sparkles',
        description: 'Harry nhận trách nhiệm làm marketing cho spa trong thị trường cạnh tranh gắt gao tại Sài Gòn. Harry tự học chụp ảnh, dựng video, tự chạy quảng cáo tối ưu ngân sách. Harry quyết định dừng lại khi thấy bản thân đang ôm đồm quá nhiều việc cùng lúc dẫn đến quá tải, không còn thời gian để thở.',
        lesson: 'Bài học: Harry học được cách buông bớt những thứ không quan trọng để tập trung bảo toàn năng lượng cho việc cốt lõi.',
      ...
      },
      {
        ...
        iconName: 'Coffee',
        description: 'Harry đi làm bưng bê tiệc cưới và buffet sáng tại khách sạn Rex. Một công việc tay chân vất vả đòi hỏi sự nhẫn nại cao, đứng liên tục nhiều giờ liền. Nhưng bù lại, Harry có cơ hội quan sát thực tế cách phục vụ khách hàng cao cấp và rèn luyện cho mình tính kiên trì, chịu khó từ những việc nhỏ nhất.',
        lesson: 'Bài học: Harry học được sự khiêm nhường và thấu hiểu khách hàng từ những trải nghiệm tay chân bình dị.',
      ...
      },
      {
        ...
        description: 'Harry phụ trách lên nội dung, làm video ngắn giới thiệu sản phẩm chay sạch trên TikTok và các sàn thương mại điện tử. Harry chọn dừng công việc sớm khi nhận thấy định hướng phát triển lâu dài của doanh nghiệp không còn đồng nhất với mục tiêu học hỏi ngắn hạn của mình.',
        lesson: 'Bài học: Harry học được cách dũng cảm dừng lại đúng lúc để tránh làm mất thời gian của cả hai bên.',
      ...
      },
      {
        ...
        iconName: 'HelpCircle',
        description: 'Harry tư vấn giải pháp phần mềm GoSell hỗ trợ các hộ kinh doanh và doanh nghiệp vừa và nhỏ tối ưu quy trình bán hàng. Harry lắng nghe câu chuyện kinh doanh thực tế từ nhiều chủ cửa hàng. Harry dừng lại khi cảm thấy môi trường và bộ máy vận hành nội bộ không còn phù hợp với hệ giá trị nhân văn của mình.',
        lesson: 'Bài học: Harry hiểu ra một sản phẩm tốt đến mấy cũng cần một bộ máy vận hành nhân văn để đi được dài hạn.',
      ...
      },
      {
        ...
        iconName: 'Utensils',
        description: 'Harry phụ trách điều phối bếp, order và chăm sóc khách hàng tại quán chay của chị hai. Harry trực tiếp chuẩn hóa lại quy trình gọi món, trò chuyện lắng nghe phản hồi của thực khách và tự mày mò học hỏi các công thức món chay mới để hoàn thiện menu.',
        lesson: 'Bài học: Vận hành một quán ăn nhỏ dạy Harry bài học về sự chi tiết, tỉ mỉ và cái tâm đặt vào từng đĩa ăn phục vụ khách.',
      ...
      },
      {
        ...
        iconName: 'Sprout',
        description: 'Harry tự nghiên cứu công thức, tự sản xuất nhang thảo mộc sạch và tự tìm khách hàng qua mạng xã hội. Harry bán được hơn 300 sản phẩm đầu tiên. Tuy nhiên, Harry phải dừng dự án sau 3 tháng do cạn kiệt nguồn vốn dự phòng, sức khỏe suy giảm và thiếu kinh nghiệm quản trị dòng tiền.',
        lesson: 'Bài học: Dự án thất bại đầu đời dạy Harry bài học đắt giá về tầm quan trọng của dòng tiền và quản trị rủi ro khi tự kinh doanh.',
      ...
      },
      {
        ...
        iconName: 'Award',
        description: 'Harry tham gia tổ chức sinh hoạt hè, quản trò và hỗ trợ hoạt động Đoàn thanh niên ở quê nhà Duy Xuyên. Harry tự xây dựng website Đoàn xã để phục vụ công tác truyền thông tin tức. Quá trình làm việc tập thể giúp Harry tự tin đứng trước đám đông và rèn luyện sự kết nối.',
        lesson: 'Bài học: Harry nhận ra công nghệ sẽ phát huy giá trị lớn nhất khi phục vụ cho cộng đồng và gieo những điều tốt lành.',
      ...
      },
      {
        ...
        iconName: 'Code',
        description: 'Sau khi tốt nghiệp, Harry bắt đầu làm Freelance Developer thiết kế giao diện web. Công việc giúp Harry rèn luyện tư duy logic tốt. Tuy nhiên, sau 6 tháng ngồi lì trước laptop, Harry bị đau mỏi vai gáy và cảm thấy chán nản. Harry nhận ra tính cách mình cần sự vận động và kết nối nhiều hơn.',
        lesson: 'Bài học: Harry học cách dũng cảm lắng nghe cơ thể và bước ra khỏi vùng an toàn khi nhận ra công việc không còn phù hợp.',
