        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex p-1 rounded-xl bg-sand/30 border border-olive/10 w-full md:w-auto max-w-lg">
            <button
              ...
              className={`flex-1 md:flex-initial text-xs font-bold px-5 py-2.5 rounded-lg transition-all duration-300 cursor-pointer flex items-center justify-center gap-2 ${
                filterType === 'all'
            ...
            >
              Tất cả
              <span className={`text-[9px] font-extrabold px-2 py-0.5 rounded-full ${filterType === 'all' ? 'bg-cream/20 text-cream' : 'bg-sand text-stone-550 border border-stone-200'}`}>
                {counts.total}
              </span>
            </button>
            <button
        ...
        {categories.length > 0 && (
          <div className="flex flex-wrap gap-2 items-center pt-4 border-t border-olive/10">
            ...
            <button
              ...
              className={`text-xs font-bold px-4 py-1.5 rounded-full transition-all duration-300 cursor-pointer ${
